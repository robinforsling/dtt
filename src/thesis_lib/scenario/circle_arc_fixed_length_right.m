...
% is to the right. x0 defines the first point and head0 defines the initial
% heading.
%
% Possible function calls:
% 1. circle_arc_fixed_length_right(in_par,r,L,N) or
% 2. circle_arc_fixed_length_right(x0,head0,r,L,N)
% where N is optional
%
