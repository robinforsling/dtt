function [COIN,ANEES,GEVO,PCO] = gevo_fusion_example
% --- gevo_fusion_example() -----------------------------------------------
% Parametrized fusion example in the numerical evaluation of GEVO in paper:
% "Decentralized State Estimation In A Dimension-Reduced Linear Regression"
%
% 2023-11-28 Robin Forsling
