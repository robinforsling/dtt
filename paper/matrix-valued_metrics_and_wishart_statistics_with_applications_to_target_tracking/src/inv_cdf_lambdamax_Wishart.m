function [x,varargout] = inv_cdf_lambdamax_Wishart(m,n,P,varargin)
% --- inv_cdf_lambdamax_Wishart() -----------------------------------------
% Computes the inverse of the CDF of the largest eigenvalue of a matrix 
...
x = xmid;
if nargout > 1; varargout{1} = CDF(m,n,x); end
